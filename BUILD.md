...
Windows and macOS builds are covered in the main [`readme.md`](readme.md); on Windows,
[`scripts/deploy-assets.ps1`](scripts/deploy-assets.ps1) is the counterpart to
`deploy-assets.sh` for staging and validating game assets.
